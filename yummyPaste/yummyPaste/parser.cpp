...
struct
{
    ...
    { (LPSTR)"{ 0xFA, 0xDE, 0x24, 255 } '\\xde\\xBF\\xf'", {0xfa, 0xde, 0x24, 255, 0xde, 0xbf, 0xf}, FALSE},
    { (LPSTR)"\r\n   124, 65 0x95 21,0x44 '\\xaa\\xee'", {124, 65, 0x95, 21, 0x44, 0xaa, 0xee}, FALSE},
    { (LPSTR)"'\\xde\\xad\\xbe\\xef\\x41\\x41'", {0xde, 0xad, 0xbe, 0xef, 0x41, 0x41}, FALSE},
    { (LPSTR)"{ 0xFA, 0xDEx, 0x24, 255 } '\\xde\\xBF\\xf'", {0xfa, 0xde, 0x24, 255, 0xde, 0xbf, 0xf}, TRUE},
